...
- [<span class="toc-section-number">5</span>
  ...
  - [<span class="toc-section-number">5.2</span>
    第二節、外送平台各類別物價變動情況－商家加權](#第二節外送平台各類別物價變動情況商家加權)
  - [<span class="toc-section-number">5.3</span>
    第三節、外送平台各類別物價變動情況－消費者加權](#第三節外送平台各類別物價變動情況消費者加權)
...
下圖為各其篩選出的樣本店家數以及當期foodpanda總店家數。由於並非每一期都能在平台上抓取到完整數據，而這種情況對於能夠有效使用的樣本數產生直接的影響。此外，因為篩選的標準是店家要在當期與下一期皆存在，因此像2023年8月13日這天只抓取到13248間店家，也會同時降低上一期2023年8月6日的有效樣本數，凸顯了資料在蒐集上的限制。
...
下圖為各日期CPI上漲率為零的店家所占比例，可以發現到當間隔天數越長，通膨為零的店家比例會降低。例如：間隔天數最長的為3月25日的33天，通膨為零的店家比例亦為最低的88.34%。間隔天數次長的為10月4日的24天，通膨為零的店家比例為次低的95.10%。而間隔天數第三的為7月1日的21天，通膨為零的店家比例同時也是第三低的95.49%。
...
圖表為原始資料的CPI上漲率及經縣市加權的CPI上漲率，可以看出兩者之間幾乎相當，僅有六天的差距超過0.1%。2023年3月4日這天，經縣市加權後的CPI上漲率比原始數據高出約0.2511%。以及在2023年8月28日到2023年9月21日這段期間出現些微的差距，經縣市加權的CPI上漲率略低於原始資料的CPI上漲率，但總體來說並無顯著差異。這也顯示了每期所選出的樣本並無偏離基準期，以店家所在縣市來看，樣本能夠有效反映出母體中各個縣市的分配情況。
...
下表為各期所選的樣本店家區域類別的占比。有別於母體台式及無區域兩類占比相當，皆在37%左右，每期所篩選出的樣本則是以台式占多數，每期的兩個類別幾乎皆有20%以上的差距。將根據店家的類別進行加權處理，以確保每一種類型的的店家樣本能夠反映母體的區域類型結構。
...
比較未經加權的CPI上漲率及經區域類別加權的CPI上漲率，可以觀察到在2023年7月1日以前，經區域類別加權的CPI上漲率普遍略高於未加權的CPI上漲率。而在2023年7月1日以後，經區域類別加權的CPI普遍低於未加權的CPI上漲率。總體而言可以在圖中觀察出兩者間的差距，而差距最大的為2023年7月22日的0.8519%，這可能來自於2023年7月22日台式與無區域類別樣本比例有關，台式占56.1742%、無區域占14.4335%，兩者間的樣本占比達到41.7407%的差距。\[圖10\]
...
下表為各期所選的樣本店家營業時段的占比。每一期皆以午晚餐為主要類別，皆有著接近60%的占比。整體而言，所有類別的占比和母體差距不大，也間接說明樣本選擇在營業時段這個面向下，具有良好的代表性。然而，在2023年年底出現些微改變。特別是晚餐的占比下降，而早午餐的占比則呈現上升趨勢。2023年11月15日、11月29日和12月6日的晚餐占比分別為19.3896%、8.9765%、6.8898%；同期早午餐的占比則分別為10.5471%、18.4706%、25.5474%。
...
比較兩者間的差距可以發現到，在6月14日之前，加權過的CPI上漲率通常略高於未經加權的數據。特別是在2月10日和3月4日，加權CPI上漲率與未加權上漲率之間的差距分別達到了0.5468%和0.8584%，顯示出加權方法對於反映某些地區或類別有產生影響。然而，從6月14日以後的情況看，這一趨勢出現了反轉。多數時間裡，未經加權的CPI上漲率反而顯示出更高的上漲率。\[圖14\]
...
下圖為未加權CPI上漲率與經縣市、營業時段加權後CPI上漲率的對比。從圖中可以觀察到，兩條曲線大致上呈現相同的趨勢，直到3月25日前，經加權調整後的CPI上漲率普遍略低於未加權的上漲率，顯示了在初期，考慮地區和營業時段的差異後，一些地區或特定時段的價格可能低於平均水平水準。這也有別於經縣市、區域類別加權的結果。然而，從3月25日之後，兩條曲線的走勢幾乎重疊。

直到7月26日，才又出現顯著的差異，其中加權後的CPI上漲率比未加權的上漲率高出0.6106%。進入8月6日之後，兩者的趨勢線再度出現重合，這表明加權和未加權的上漲率變得相當接近。然而，到了11月29日，加權和未加權的CPI上漲率又表現出了相反的走勢，顯現了經縣市、營業時段加權後與未經加權的CPI產生不一樣的結果。\[圖15\]
...
在進行未加權CPI上漲率與經區域類別、營業時段加權後CPI上漲率的比較中，可以發現經加權的CPI上漲率展現出較大的波動幅度。這一現象特別明顯於2023年2月3日至2023年3月4日這段期間。在這個月內，經過區域類別和營業時段加權的CPI上漲率不僅呈現更劇烈的變動，而且與未加權的CPI上漲率相比，這種差異更為明顯。\[圖16\]
...
經縣市、區域類別以及營業時段加權的CPI上漲率與未經加權的上漲率之間，可以觀察出幾個細微的變化。首先是在2月10日這天，經加權後的上漲率高於未經加權上漲率，在隔週2月17日兩者皆呈現下降趨勢，但經加權的資料變動幅度較大。接著在2月24日、3月4日，兩者也在同步上升，但依然是經加權的上漲率漲幅較大，可以發現到這段期間經加權的CPI波動較為明顯。一直到5月16日，兩者皆顯著下降至2%左右的水準。而後又在5月31日達到高點，經加權與未加權分別為6.0126%及6.7868%。6月5日則修正回3%的水準，一直維持至7月22日。7月26日再度出現明顯下降，經加權與未加權分別為0.7266%及1.1558%。之後兩者的走勢相當，直到12月6日，經加權的上漲率下跌，未經加權的上漲率上升，兩者出現反向的變化。

從圖中可以看出，儘管整體趨勢保持一致，但在具體的時間點上，加權CPI和未加權CPI之間存在著差異。\[圖17\]
...
價格替代偏誤發生於消費者因應價格變動而改變消費習慣，從而選擇性購買較便宜的商品。而傳統物價指數編製方法也忽略了消費者可能會有這樣的替代效果，因此本節將改以消費者面向調整權數，以更全面地評估CPI變化。

店家所在縣市、商家類別以及營業時段皆為店家選擇，而在foodpanda上必須由消費者完成該次訂購後才能留下評論。當該期店家的評論增加數越多，同時也代表有更多消費者在這期選擇該店家商品。因此本文選擇以平台上店家每期的評論增加數來衡量店家是否在這期受到消費者的青睞。
...
<img src="image/compared.png" width="1000" />
...
## 第二節、外送平台各類別物價變動情況－商家加權

首先，將計算以商家加權的各縣市CPI。由於桃園市與台南市並無自主調查物價資料，因此將先重點比較六大直轄市，包括台北市、新北市、桃園市、台中市、台南市和高雄市的CPI上漲率變化。整體來看，每個直轄市的CPI上漲率均展現出不同的波動方式，反映了各地區物價變動的異質性。

2024年3月18日這一天，六個直轄市均呈現上漲趨勢，其中桃園市的CPI上漲率高達13.2723%。一周後的2023年3月25日，除了桃園市仍維持在10.8672%的CPI上漲率外，其他五都的CPI上漲率均降至10%以下。從四月份開始，臺南市的波動幅度顯著增大。2023年5月9日，臺南市的CPI上漲率達到最高的9.2868%，但到了5月16日卻變成六都中最低的-0.9929%。兩周後的5月23日，臺南市的CPI上漲率再次飆升至13.0494%，但在6月5日又降至-2.3955%，顯示了臺南市物價變化的不穩定性。

在同一時期，高雄市的CPI水準相對平穩，直到11月29日才出現較其他直轄市明顯的漲幅，達到9.9364%。台中市在除了8月13日達到8.9072%的上漲率外，其餘時間均維持在一個穩定的水平。台北市在3月18日雖然有著9.0834%的上漲率，但當天六個直轄市的CPI上漲率均超過8%，推測可能是平台全面的售價調整所致。此外，以商家加權的面向來看，台北市是六都中物價最穩定的直轄市。

<img src="image/shop_municipality.png" width="1000" />

第二，將分析各個類別的CPI上漲率。由於台式、東南亞、港式及韓式類別的店家占比較低，因此重點比較中式、無區域、歐美及日式四個主要類別。從2月開始，四個類別的CPI上漲率走勢相當一致。直到5月9日這天歐美的CPI上漲率飆漲至16.3949%，隔週的5月16日又降至1.2282%，兩週後的5月31日又再度飆升至29.5855%。到了7月22至8月13日這段期間CPI上漲率皆呈現負值，直到8月28日再度上升至17.8386%。可以從此觀察到歐美類型的物價變動相當大。而其他三個類別的波動則較一致，唯獨日式料理在8月6日和8月13日有著相對明顯的上漲，分別為5.2398%及9.6871%。

<img src="image/shop_catRegion.png" width="1000" />

最後，將比較各營業時段間的CPI上漲率。由於營業時段為早午餐、午晚餐、晚餐以及早午晚餐占多數，因此著重在這四個類別的比較。2月17日這天，相比於其他三個時段，提供全天餐點的早午晚餐類別CPI表現出上升趨勢。然而，從3月至5月中旬，四個時段的CPI走勢並未顯示出顯著差異，整體而言，各時段的物價指數相對穩定。

到了5月31日則出現明顯的變化，早午餐類的CPI飆升至30.6656%，然而，指數在短短五天後迅速調整，回落至只有0.7188%的水平。自此之後，早午餐的CPI上漲率保持在3%以內直至年底，顯示出一定的穩定性。

接著觀察營業時段為早午晚餐的CPI。CPI在7月26日出現了明顯的下跌，降至-14.0997%。這一大幅下降後不久，8月28日該CPI上漲率又回升至15.9494%。後續則在CPI在-3%至2%之間小幅波動，直到11月29日又一次出現了15.9833%的大幅上升，表明了全天候供應的餐飲服務物價指數在後半年面臨較大的不確定性和變動性。相比之下，午晚餐以及晚餐類別的CPI則顯示出較為平穩的上漲趨勢。

<img src="image/shop_businessHour.png" width="1000" />

## 第三節、外送平台各類別物價變動情況－消費者加權
